...
#ifndef LOCK_FREE_EHT_LOCK_GURAD_PAGE_H
#define LOCK_FREE_EHT_LOCK_GURAD_PAGE_H
#pragma once
...
public:
  ...
  auto MarkDirty() -> void { guard_.is_dirty_ = true; }
...
#endif // LOCK_FREE_EHT_LOCK_GURAD_PAGE_H
