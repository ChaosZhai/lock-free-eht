...
public:
   ...
   */
  auto Size() const -> uint32_t { return 1U << global_depth_; }

  /**
   * @return the max directory size
   */
  auto MaxSize() const -> uint32_t { return 1U << max_depth_; }
...
static_assert(sizeof(ExtendibleHTableDirectoryPage) <= BUCKET_SIZE);
