...
#ifndef LOCK_FREE_EHT_PAGE_MANAGER_H
#define LOCK_FREE_EHT_PAGE_MANAGER_H
...
constexpr size_t BUFFER_POOL_UNLIMITED_SIZE = 500000;
/**
...
public:
  ...
  BufferPoolManager(size_t pool_size)
          : pool_size_(BUFFER_POOL_UNLIMITED_SIZE) {
  ...
  auto NewPage(page_id_t *page_id) -> Page *{
      ...
      if (static_cast<size_t>(new_page_id) >= pool_size_) {
          return nullptr;
      }
      auto new_page = &pages_[new_page_id];
      *page_id = new_page_id;
      return new_page;
  }
...
#endif // LOCK_FREE_EHT_PAGE_MANAGER_H